...
const world = {
  worldVersion: "test",
  scenes: [{ id: "S1", paths: [path] }],
};
const frontiers = { frontiers: [{ branch_id: "B1", current_scene_id: "S1", path_id: "S1-P1", depth: 4 }] };
const confirmed = {
...
test("validateProductionQueue accepts one exact-4:3 staged candidate", () => {
  const queue = {
    worldVersion: "test",
