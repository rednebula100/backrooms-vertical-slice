...
현재 20장 주기에서 12장이 사람 검수를 거쳐 정식 장면으로 승격되었다. 첫 웨이브 10장에 이어, 같은 원본의 서로 다른 사람 확정 통로에서 경로 패킷으로 만든 두 장도 승격되었다. 여기서 생긴 최전선을 이용해 남은 8장을 생성한다. 따라서 “20장”은 한 번에 서로 무관한 이미지를 만드는 숫자가 아니라, 연결성이 유지된 후보 20장을 완성하는 주기다.
