...
현재 20장 주기는 사람 검수를 거쳐 정식 장면으로 승격된 12장과, 경로 패킷에서 생성되어 통로 검수를 기다리는 8장으로 채워졌다. 새 후보는 서로 다른 8개 공간 원형을 사용하며, 출발 장면의 사람 확정 마스크·카메라 이동·공간 관계를 각각 보존한다. 따라서 “20장”은 서로 무관한 이미지 수가 아니라 연결성이 유지된 정식 장면과 검수 후보의 합계다. 다음 단계는 8장의 실제 통로를 에디터에서 표시하고 검수 완료하는 것이다.
